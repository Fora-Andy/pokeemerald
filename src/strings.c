...
const u8 gExpandedPlaceholder_Emerald[] = _("绿宝石");
const u8 gExpandedPlaceholder_Aqua[] = _("海洋");
...
const u8 gExpandedPlaceholder_Brendan[] = _("小悠");
const u8 gExpandedPlaceholder_May[] = _("小遥");
const u8 gText_EggNickname[] = _("蛋");
const u8 gText_Pokemon[] = _("宝可梦");
const u8 gProfBirchMatchCallName[] = _("小田卷博士");
...
const u8 gUnknown_085E836D[] = _("更新中的记录正在\n使用外部数据。请稍等。");
const u8 gUnknown_085E83A2[] = _("记录已更新完毕。");
...
const u8 gUnknown_085E84BF[] = _("玩家");
const u8 gUnknown_085E84C6[] = _("图鉴");
const u8 gText_MainMenuTime[] = _("时间");
const u8 gUnknown_085E84D3[] = _("徽章");
const u8 gUnknown_085E84DA[] = _("A键");
const u8 gUnknown_085E84E3[] = _("B键");
const u8 gUnknown_085E84EC[] = _("R键");
const u8 gUnknown_085E84F5[] = _("L键");
const u8 gUnknown_085E84FE[] = _("START");
const u8 gUnknown_085E8504[] = _("SELECT");
const u8 gUnknown_085E850B[] = _("+ 十字键");
const u8 gUnknown_085E8519[] = _("L键  R键");
const u8 gUnknown_085E852C[] = _("控制器");
ALIGNED(4) const u8 gUnknown_085E8538[] = _("{DPAD_UPDOWN}拾取 {A_BUTTON}OK");
ALIGNED(4) const u8 gUnknown_085E8544[] = _("{A_BUTTON}下面");
ALIGNED(4) const u8 gUnknown_085E854C[] = _("{A_BUTTON}下面 {B_BUTTON}返回");
...
ALIGNED(4) const u8 gText_UnkCtrlF800Exit[] = _("{A_BUTTON}退出");
...
const u8 gUnknown_085E8785[] = _("没有找到符合条件的宝可梦。");
const u8 gUnknown_085E87A5[] = _("搜寻宝可梦\n请选择条件。");
const u8 gUnknown_085E87D6[] = _("切换图鉴排列。");
const u8 gUnknown_085E87EF[] = _("返回图鉴。");
const u8 gUnknown_085E8806[] = _("选择图鉴模式。");
const u8 gUnknown_085E881F[] = _("选择图鉴排列模式。");
const u8 gUnknown_085E8840[] = _("请指定名字的首字,\n限已发现的宝可梦。");
const u8 gUnknown_085E887C[] = _("请指定宝可梦的体色,\n限已发现的宝可梦。");
const u8 gUnknown_085E88A6[] = _("请指定属性,\n限已抓过的宝可梦。");
const u8 gUnknown_085E88C8[] = _("搜寻开始。");
...
const u8 gText_SwitchPkmnItem[] = _("{STR_VAR_1}已经携带了\n{STR_VAR_2}。\p要和持有的道具\n交换吗?");
...
const u8 gText_XNatureMetAtYZ[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n于{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}在\n{SPECIAL_F7 0x00}{SPECIAL_F7 0x04}{SPECIAL_F7 0x01}相遇。");
const u8 gText_XNatureHatchedAtYZ[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n于{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}在\n{SPECIAL_F7 0x00}{SPECIAL_F7 0x04}{SPECIAL_F7 0x01}邂逅。");
const u8 gText_XNatureObtainedInTrade[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n通过交换相识。");
const u8 gText_XNatureFatefulEncounter[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n于{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}\n命中注定般邂逅。");
const u8 gText_XNatureProbablyMetAt[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n可能在{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01},\n{SPECIAL_F7 0x00}{SPECIAL_F7 0x04}{SPECIAL_F7 0x01}时相遇。");
const u8 gText_XNature[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格");
const u8 gText_XNatureMetSomewhereAt[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n于{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}某处遇到。");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{SPECIAL_F7 0x00}{SPECIAL_F7 0x02}{SPECIAL_F7 0x01}{SPECIAL_F7 0x05} 性格,\n在{LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}处孵化。");
...
const u8 gUnknown_085EAD37[] = _("橙华");
const u8 gUnknown_085EAD41[] = _("凯那");
const u8 gUnknown_085EAD4B[] = _("未白");
const u8 gUnknown_085EAD56[] = _("水静");
const u8 gUnknown_085EAD5F[] = _("武斗");
const u8 gUnknown_085EAD67[] = _("进入");
const u8 gUnknown_085EAD6D[] = _("说明");
const u8 gUnknown_085EAD72[] = _("华丽大赛是什么?");
const u8 gUnknown_085EAD84[] = _("华丽大赛的类型");
const u8 gUnknown_085EAD96[] = _("级别");
const u8 gUnknown_085EAD9C[] = _("审查");
...
const u8 gUnknown_085EADF9[] = _("装饰");
const u8 gUnknown_085EAE04[] = _("收好");
const u8 gUnknown_085EAE0C[] = _("总数");
const u8 gUnknown_085EAE12[] = _("注册簿");
const u8 gUnknown_085EAE1B[] = _("情报");
const u8 gUnknown_085EAE27[] = _("音速");
const u8 gUnknown_085EAE2C[] = _("越野");
const u8 gUnknown_085EAE31[] = _("PSN");
const u8 gUnknown_085EAE35[] = _("麻痹");
const u8 gUnknown_085EAE39[] = _("睡眠");
const u8 gUnknown_085EAE3D[] = _("灼烧");
const u8 gUnknown_085EAE41[] = _("冰冻");
const u8 gUnknown_085EAE45[] = _("中毒");
const u8 gUnknown_085EAE4B[] = _("OK");
const u8 gUnknown_085EAE4E[] = _("退出");
const u8 gUnknown_085EAE53[] = _("知道了");
const u8 gUnknown_085EAE5A[] = _("还没");
const u8 gText_Yes[] = _("是");
const u8 gText_No[] = _("否");
const u8 gUnknown_085EAE69[] = _("说明");
const u8 gUnknown_085EAE6E[] = _("单打对战");
const u8 gUnknown_085EAE7C[] = _("双打对战");
const u8 gUnknown_085EAE8A[] = _("多人对战");
const u8 gUnknown_085EAE97[] = _("哈奇");
const u8 gUnknown_085EAEA2[] = _("挑战");
const u8 gUnknown_085EAEAC[] = _("说明");
const u8 gText_Lv50[] = _("LV. 50");
const u8 gText_OpenLevel[] = _("自由级");
const u8 gUnknown_085EAEC3[] = _("美味之水{CLEAR_TO 0x48}200元");
const u8 gUnknown_085EAED6[] = _("劲爽汽水{CLEAR_TO 0x48}300元");
const u8 gUnknown_085EAEE6[] = _("果汁牛奶{CLEAR_TO 0x48}350元");
const u8 gUnknown_085EAEF6[] = _("怎么骑");
const u8 gUnknown_085EAF02[] = _("怎么开");
const u8 gUnknown_085EAF0E[] = _("流沙坡");
const u8 gUnknown_085EAF1B[] = _("单轮特技");
const u8 gUnknown_085EAF24[] = _("小跳");
const u8 gUnknown_085EAF2F[] = _("跳");
const u8 gUnknown_085EAF34[] = _("满意");
const u8 gUnknown_085EAF3E[] = _("不满意");
const u8 gUnknown_085EAF4B[] = _("深海之牙");
const u8 gUnknown_085EAF58[] = _("深海鳞片");
const u8 gUnknown_085EAF65[] = _("蓝色玻璃哨");
const u8 gUnknown_085EAF70[] = _("黄色玻璃哨");
const u8 gUnknown_085EAF7D[] = _("红色玻璃哨");
const u8 gUnknown_085EAF87[] = _("白色玻璃哨");
const u8 gUnknown_085EAF93[] = _("黑色玻璃哨");
const u8 gUnknown_085EAF9F[] = _("玻璃凳子");
const u8 gUnknown_085EAFAB[] = _("玻璃桌子");
const u8 gUnknown_085EAFB6[] = _("木守宫布偶 1000代币");
const u8 gUnknown_085EAFCF[] = _("火稚鸡布偶 1000代币");
const u8 gUnknown_085EAFE8[] = _("火稚鸡布偶 1000代币");
const u8 gUnknown_085EB002[] = _("50代币 1000元");
const u8 gUnknown_085EB017[] = _("500代币  10000元");
const u8 gUnknown_085EB02A[] = _("很好");
const u8 gUnknown_085EB034[] = _("不好");
const u8 gUnknown_085EB040[] = _("红色碎片");
const u8 gUnknown_085EB04A[] = _("黄色碎片");
const u8 gUnknown_085EB057[] = _("蓝色碎片");
const u8 gUnknown_085EB062[] = _("绿色碎片");
const u8 gText_BattleFrontier[] = _("对战开拓区");
const u8 gUnknown_085EB07E[] = _("右");
const u8 gUnknown_085EB084[] = _("左");
const u8 gUnknown_085EB089[] = _("TM32{CLEAR_TO 0x48}1,500代币");
const u8 gUnknown_085EB09C[] = _("TM29{CLEAR_TO 0x48}3,500代币");
const u8 gUnknown_085EB0AF[] = _("TM35{CLEAR_TO 0x48}4,000代币");
const u8 gUnknown_085EB0C2[] = _("TM24{CLEAR_TO 0x48}4,000代币");
const u8 gUnknown_085EB0D5[] = _("TM13{CLEAR_TO 0x48}4,000代币");
...
const u8 gUnknown_085EB29A[] = _("红帐篷");
const u8 gUnknown_085EB2A3[] = _("蓝帐篷");
...
const u8 gUnknown_085EB2E4[] = _("爪子化石");
const u8 gUnknown_085EB2F0[] = _("根状化石");
const u8 gUnknown_085EB2FC[] = _("不");
const u8 gUnknown_085EB2FF[] = _("我现在要对战了!");
const u8 gUnknown_085EB310[] = _("赢了!");
const u8 gUnknown_085EB317[] = _("输了!");
const u8 gUnknown_085EB31F[] = _("我不想说。");
...
const u8 gUnknown_085EB372[] = _("交换中心");
const u8 gUnknown_085EB37F[] = _("竞技场");
const u8 gUnknown_085EB389[] = _("联机中心");
const u8 gUnknown_085EB397[] = _("树果混合");
const u8 gUnknown_085EB3A3[] = _("");
const u8 gUnknown_085EB3A4[] = _("宝可梦跳绳");
const u8 gUnknown_085EB3B1[] = _("嘟嘟利摘树果");
const u8 gUnknown_085EB3C6[] = _("成为队长");
const u8 gUnknown_085EB3D4[] = _("加入队伍");
const u8 gUnknown_085EB3DF[] = _("两种模式");
const u8 gUnknown_085EB3EA[] = _("LV. 50");
const u8 gUnknown_085EB3F1[] = _("自由级");
const u8 gUnknown_085EB3FC[] = _("宝可梦属性&编号");
const u8 gUnknown_085EB40A[] = _("持有道具");
const u8 gUnknown_085EB415[] = _("象征");
const u8 gUnknown_085EB41D[] = _("记录");
const u8 gUnknown_085EB424[] = _("战斗点数");
const u8 gUnknown_085EB42F[] = _("对战塔信息");
const u8 gUnknown_085EB43A[] = _("对战宝可梦");
const u8 gUnknown_085EB444[] = _("对战沙龙");
const u8 gUnknown_085EB451[] = _("多人联机");
const u8 gUnknown_085EB45C[] = _("对战规则");
const u8 gUnknown_085EB469[] = _("裁判:注意");
const u8 gUnknown_085EB475[] = _("裁判:技巧");
const u8 gUnknown_085EB482[] = _("裁判:主体");
const u8 gUnknown_085EB48E[] = _("对手");
const u8 gUnknown_085EB496[] = _("对阵树");
const u8 gUnknown_085EB4A3[] = _("双双击倒");
const u8 gUnknown_085EB4AD[] = _("基本规则");
const u8 gUnknown_085EB4B9[] = _("交换:搭档");
const u8 gUnknown_085EB4C7[] = _("交换:数量");
const u8 gUnknown_085EB4D4[] = _("交换:记录");
const u8 gUnknown_085EB4E0[] = _("自由级");
...
const u8 gUnknown_085EB532[] = _("金字塔:宝可梦");
const u8 gUnknown_085EB543[] = _("金字塔:训练家");
const u8 gUnknown_085EB555[] = _("金字塔:迷宫");
const u8 gUnknown_085EB563[] = _("对战时背包");
const u8 gUnknown_085EB56E[] = _("领航员和背包");
const u8 gUnknown_085EB57E[] = _("持有道具");
const u8 gUnknown_085EB589[] = _("宝可梦指令");
const u8 gUnknown_085EB597[] = _("对战宝可梦");
const u8 gText_BattleTrainers[] = _("对战训练家");
const u8 gUnknown_085EB5B6[] = _("继续");
const u8 gUnknown_085EB5BC[] = _("记录");
const u8 gUnknown_085EB5C3[] = _("休息");
const u8 gUnknown_085EB5C8[] = _("退赛");
...
const u8 gText_PkmnIsSelected[] = _("{SPECIAL_F7 0x00} 被选中了。");
const u8 gText_JumpToWhichBox[] = _("要移动去哪个盒子？");
const u8 gText_DepositInWhichBox[] = _("要寄存在哪个盒子里？");
const u8 gText_PkmnWasDeposited[] = _("{SPECIAL_F7 0x00} 已经寄存了。");
const u8 gText_BoxIsFull2[] = _("这个盒子满了！");
const u8 gText_ReleaseThisPokemon[] = _("放生这个宝可梦？");
const u8 gText_PkmnWasReleased[] = _("{SPECIAL_F7 0x00} 已被放生。");
const u8 gText_ByeByePkmn[] = _("拜拜, {SPECIAL_F7 0x00}!");
...
const u8 gText_PkmnCameBack[] = _("{SPECIAL_F7 0x00} 你快回来！");
...
const u8 gText_ItemIsNowHeld[] = _("正带着{SPECIAL_F7 0x00}。");
const u8 gText_ChangedToNewItem[] = _("更改为{SPECIAL_F7 0x00}。");
...
const u8 gUnknown_085EBCC5[] = _("查看代提地区的地图");
const u8 gUnknown_085EBCE8[] = _("详细地查看宝可梦。");
const u8 gUnknown_085EBD01[] = _("呼叫已登记的训练家。");
const u8 gUnknown_085EBD1C[] = _("检查已得到的奖章。");
const u8 gUnknown_085EBD34[] = _("放好领航员。");
const u8 gText_NoRibbonWinners[] = _("没有奖章获得者。");
const u8 gUnknown_085EBD67[] = _("没有登记训练家。");
const u8 gUnknown_085EBD83[] = _("详细地查看持有宝可梦。");
const u8 gUnknown_085EBDA2[] = _("详细地查看所有宝可梦。");
const u8 gUnknown_085EBDBF[] = _("返回领航员主菜单。");
const u8 gUnknown_085EBDDB[] = _("查找帅气的宝可梦。");
const u8 gUnknown_085EBDEE[] = _("查找美丽的宝可梦。");
const u8 gUnknown_085EBE06[] = _("查找可爱的宝可梦。");
const u8 gUnknown_085EBE19[] = _("查找聪明的宝可梦。");
const u8 gUnknown_085EBE2D[] = _("查找强壮的宝可梦。");
const u8 gUnknown_085EBE41[] = _("返回情报菜单。");
const u8 gText_NumberRegistered[] = _("已登记数量");
const u8 gText_NumberOfBattles[] = _("已战斗次数");
const u8 gUnknown_085EBE7D[] = _("详细");
const u8 gUnknown_085EBE84[] = _("呼叫");
const u8 gUnknown_085EBE89[] = _("退出");
const u8 gUnknown_085EBE8E[] = _("你不能在这里呼叫对手！");
...
const u8 gUnknown_085EBFDC[] = _("奖章数");
...
const u8 gUnknown_085EC017[] = _("呼叫");
const u8 gUnknown_085EC01C[] = _("查看");
const u8 gUnknown_085EC022[] = _("取消");
const u8 gText_NumberF700[] = _("No. {SPECIAL_F7 0x00}");
const u8 gText_RibbonsF700[] = _("奖章 {SPECIAL_F7 0x00}");
...
const u8 gText_RegisteredTextChanged[] = _("登记的文本已经改变了,\n是否保存游戏？");
const u8 gText_AlreadySavedFile_Unused[] = _("已经有记录存档了,\n是否覆盖记录？");
const u8 gText_SavingDontTurnOff_Unused[] = _("正在写入记录……\n请务切断电源。");
const u8 gText_PlayerSavedGame_Unused[] = _("{SPECIAL_F7 0x00}完好地\n写下了记录");
...
ALIGNED(4) const u8 gText_ReadyToBerryCrush[] = _("是否准备开始树果混合？\n请选择一个树果。\p");
...
const u8 gText_XPLink[] = _("{STR_VAR_1}P连接");
...
const u8 gUnknown_085EEA46[] = _("最大HP");
const u8 gUnknown_085EEA4E[] = _("物攻");
const u8 gUnknown_085EEA55[] = _("物防");
const u8 gUnknown_085EEA5D[] = _("速度");
const u8 gUnknown_085EEA63[] = _("特攻");
const u8 gUnknown_085EEA6B[] = _("特防");
...
const u8 gOtherText_ExpShareOn[] = _("打开了学习装置，\p其他宝可梦将获得部分经验值。{PAUSE_UNTIL_PRESS}");
const u8 gOtherText_ExpShareOff[] = _("关闭了学习装置。{PAUSE_UNTIL_PRESS}");
