...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ATROPOS_KOHLRABI_GARDEN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_QUIET_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_GINKGO_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_THE_GOLDEN_BAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_PLATINIUM_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_BANABA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_MACARANGA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_HUPER_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_DAVIDIA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_CURVIFOLIA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_CYCAS_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_BUBBLE_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_DIDA_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_ALPHA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_BETA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_GAMMA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_DELTA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_EPSILON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_ZETA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_ETA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_THETA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_IOTA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_KAPPA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_LAMBDA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATROPOS_ROUTE_MU] = MAPPOPUP_THEME_WOOD
};
