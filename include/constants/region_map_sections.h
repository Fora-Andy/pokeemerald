...
#define MAPSEC_ATROPOS_KOHLRABI_GARDEN      0xD5
#define MAPSEC_ATROPOS_QUIET_TOWN           0xD6
#define MAPSEC_ATROPOS_GINKGO_CITY          0xD7
#define MAPSEC_ATROPOS_THE_GOLDEN_BAY       0xD8
#define MAPSEC_ATROPOS_PLATINIUM_CITY       0xD9
#define MAPSEC_ATROPOS_BANABA_TOWN          0xDA
#define MAPSEC_ATROPOS_MACARANGA_TOWN       0xDB
#define MAPSEC_ATROPOS_HUPER_TOWN           0xDC
#define MAPSEC_ATROPOS_DAVIDIA_CITY         0xDD
#define MAPSEC_ATROPOS_CURVIFOLIA_TOWN      0xDE
#define MAPSEC_ATROPOS_CYCAS_CITY           0xDF
#define MAPSEC_ATROPOS_BUBBLE_ISLAND        0xE0
#define MAPSEC_ATROPOS_DIDA_VILLAGE         0xE1
#define MAPSEC_ATROPOS_ROUTE_ALPHA          0xE2
#define MAPSEC_ATROPOS_ROUTE_BETA           0xE3
#define MAPSEC_ATROPOS_ROUTE_GAMMA          0xE4
#define MAPSEC_ATROPOS_ROUTE_DELTA          0xE5
#define MAPSEC_ATROPOS_ROUTE_EPSILON        0xE6
#define MAPSEC_ATROPOS_ROUTE_ZETA           0xE7
#define MAPSEC_ATROPOS_ROUTE_ETA            0xE8
#define MAPSEC_ATROPOS_ROUTE_THETA          0xE9
#define MAPSEC_ATROPOS_ROUTE_IOTA           0xEA
#define MAPSEC_ATROPOS_ROUTE_KAPPA          0xEB
#define MAPSEC_ATROPOS_ROUTE_LAMBDA         0xEC
#define MAPSEC_ATROPOS_ROUTE_MU             0xED
