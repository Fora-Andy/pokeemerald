...
struct Pokedex
{
    ...
    /*0x0C*/ u32 unknown3;
    /*0x10*/ u8 filler[0x62]; // Previously Dex Flags, feel free to remove.
};
...
struct SaveBlock1
{
    ...
    /*0x790*/ struct ItemSlot bagPocket_Berries[BAG_BERRIES_COUNT];
              ...
              struct ItemSlot bagPocket_MegaStone[BAG_MEGASTONE_COUNT];
              struct ItemSlot bagPocket_ZCrystal[BAG_ZCRYSTAL_COUNT];
